   ...
   /**
    ...
    public String getFieldName(int i) throws NoSuchElementException {
        ...
        if(i < 0 || i > tdItems.length)
                throw  new NoSuchElementException( "This position" + i + "is not a valid reference");
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        ...
        for(int i = td1.numFields(); i < typeAr.length; i++) {
            typeAr[i] = td2.tdItems[i - td1.numFields()].fieldType;
            fieldAr[i] = td2.tdItems[i - td1.numFields()].fieldName;
        }
